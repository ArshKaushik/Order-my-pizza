...
var CardWidget = /*#__PURE__*/function () {
  // Think this as a variable(local variable) but in class, this is called property(local property)
...
function initAdmin(socket) {
  ...
  var orders = [];
  var markup; // HTML markup of the table
  ...
  socket.on('orderPlacedEvent', function (order) {
...
function updateStatus(order) {
  ...
  statuses.forEach(function (status) {
    var dataProp = status.dataset.status; // '.status' is for 'status' of 'data-status' in 'singleOrder.ejs' file
...
socket.on('orderUpdatedEvent', function (data) {
...
function _initStripe() {
  _initStripe = _asyncToGenerator( /*#__PURE__*/_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().mark(function _callee2() {
    var publishableClientKey, stripe, card, paymentType, paymentForm;
    return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default().wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            // Stripe
            publishableClientKey = 'pk_test_51IfcFgSDeDhZpNRaLTsurwptX4UHZQQ65SB6OtUvkyfuAF046Vx81wpNQrDFC3pCAExX2A89dYrxccXcXS6V1Z7300wrlqJrhx';
            _context2.next = 3;
            return (0,_stripe_stripe_js__WEBPACK_IMPORTED_MODULE_1__.loadStripe)(publishableClientKey);
          ...
          case 8:
            paymentType.addEventListener('change', function (e) {
              if (e.target.value === 'card') {
                // Display widget
                card = new _CardWidget__WEBPACK_IMPORTED_MODULE_3__.CardWidget(stripe); // 'new' keyword is used to create an object of the class 'CardWidget'
                    ...
                    while (1) {
                      switch (_context.prev = _context.next) {
                        case 0:
                          ...
                          formData = new FormData(paymentForm); // 'FormData()' is JS's in-built class
...
/******/ 		}
/******/ 		
/******/ 		var chunkLoadingGlobal = self["webpackChunkrealtime_pizza_order_tracker"] = self["webpackChunkrealtime_pizza_order_tracker"] || [];
